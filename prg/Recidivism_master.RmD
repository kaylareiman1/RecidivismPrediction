...
##Added these so we can make ROC curves for regression trees
#Numeric vars for recidivism - any
train.dat$response.recidany <- (as.numeric(train.dat$any_recid_2yr) - 1)
val.dat$response.recidvany <- (as.numeric(val.dat$any_recid_2yr) - 1)
test.dat$response.recidany <- (as.numeric(test.dat$any_recid_2yr) - 1)

#Numeric vars for recidivism - violent
