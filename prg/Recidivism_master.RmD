...
plot(roccurve.logit,
     ...
     print.auc = TRUE)
#LDA ROC
plot(roc_lda, col = roc_lda.col, lwd = 3, print.auc = TRUE, add = TRUE)
#QDA ROC
plot (roc_qda, col = roc_qda.col, lty = 10, print.auc = TRUE, add = TRUE)
#Tree ROC
plot (roccurve.trpart, col = roccurve.trpart.col, lty = 3, print.auc = TRUE, add = TRUE)
#Random Forest ROC
plot (roccurve.rpart, col = roccurve.rpart.col, lty = 2, print.auc = TRUE, add = TRUE)
legend(x = 42,
       y = 50,
