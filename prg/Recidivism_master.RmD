...
| Logistic regression                        |`r scales::percent(logit.acc, 0.1)` | `r scales::percent(logit.sens, 0.1)`   |`r scales::percent(logit.spec)` |  
...
| Logistic regression                        |`r scales::percent(logit.acc.vio, 0.1)` |`r scales::percent(logit.sens.vio, 0.1)` |`r scales::percent(logit.spec.vio, 0.1)` |  
...
kable(confusions.pred.test.vio, caption = "Final Results with Test Data (vio Recidivism)")
...
|------------------------------------------------------------------|-----------------|------------------|
| Labeled Higher Risk, But Didn’t Re-Offend  (False positive)      |`r FP.any.white`  | `r FP.any.AfAm` |
| Labeled Lower Risk, Yet Did Re-Offend      (False Negative)      |`r FN.any.white`  | `r FN.any.AfAm` |
...
|------------------------------------------------------------------|-----------------|------------------|
| Labeled Higher Risk, But Didn’t Re-Offend  (False positive)      |`r FP.any.female`  | `r FP.any.male` |
| Labeled Lower Risk, Yet Did Re-Offend      (False Negative)      |`r FN.any.female`  | `r FN.any.male` |
...
|------------------------------------------------------------------|-----------------|------------------|--------------|
| Labeled Higher Risk, But Didn’t Re-Offend  (False positive)      |`r FP.any.age1`  | `r FP.any.age2` | `r FP.any.age3`|
| Labeled Lower Risk, Yet Did Re-Offend      (False Negative)      |`r FN.any.age1`  | `r FN.any.age2` | `r FN.any.age3`|
