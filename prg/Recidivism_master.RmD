...
#Commented out the print() because it seemed redundant & less pretty than the picture -MH
...
From the ROC chart we do see that the AUC value is lower for the regression tree than for the logistic regression or LDA models. The regression tree allows for more nuance than the classification tree, with 
